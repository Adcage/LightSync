...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className='mx-auto max-w-4xl space-y-6 p-6'>
      <h1 className='mb-6 text-3xl font-bold text-gray-900 dark:text-gray-100'>{t('settings.title', '设置')}</h1>
      ...
      <Card>
        ...
        <CardBody className='space-y-4'>
          <div className='flex items-center justify-between'>
            ...
            <Switch isSelected={settings.autoStart} onValueChange={value => handleSettingChange('autoStart', value)} />
          </div>
        ...
        <CardBody className='space-y-4'>
          <div className='flex items-center justify-between'>
            ...
            >
              ...
              <SelectItem key='zh-TW' value='zh-TW'>
                繁體中文
              </SelectItem>
              ...
              <SelectItem key='ko-KR' value='ko-KR'>
                한국어
              </SelectItem>
            </Select>
          </div>
            ...
            <div>
              ...
              <div className='flex items-center space-x-2'>
                <input
                  ...
                  className='flex-1'
                />
                <span className='w-12 text-sm text-gray-600 dark:text-gray-400'>{settings.maxConcurrentSyncs}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className='flex items-center space-x-2'>
                <input
                  ...
                  className='flex-1'
                />
                <span className='w-12 text-sm text-gray-600 dark:text-gray-400'>{settings.bandwidthLimit} MB/s</span>
              </div>
            </div>
          </div>
        </CardBody>
        ...
        <CardBody className='space-y-4'>
          <div className='flex items-center justify-between'>
            ...
            <Select
              ...
              className='max-w-xs'
            >
              <SelectItem key='debug' value='debug'>
                Debug
              </SelectItem>
