...
export const TitleBar = () => {
  ...
  return (
    <div
      className='flex h-[35px] select-none items-center justify-between border-b border-gray-200 bg-white dark:border-zinc-800 dark:bg-zinc-900'
