      ...
      <CardBody>
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="bg-default-100 dark:bg-default-50 rounded-lg p-3 h-64 overflow-auto">
              {logs.length === 0 ? (
                <div className="text-default-400 text-sm">暂无日志</div>
              ) : (
                <div className="space-y-1">
                  {logs.map((log, index) => (
                    <div key={index} className="text-xs font-mono text-default-700 dark:text-default-300">
                      {log}
                    </div>
                  ))}
                </div>
