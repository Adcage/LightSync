   ...
   export default function DashboardPage() {
       ...
       return (
           <div className="p-6 space-y-6">
               ...
               {/* 同步状态总览 */}
               <Card className="p-4">
                   <h2 className="text-lg font-semibold mb-4">{t('dashboard.syncOverview')}</h2>
               ...
               {/* 同步文件夹列表 */}
               <Card className="p-4">
                   <h2 className="text-lg font-semibold mb-4">{t('dashboard.syncFolders')}</h2>
...
4. **创建同步文件夹页面 `src/pages/SyncFoldersPage.tsx`**
   ...
   export default function SyncFoldersPage() {
       return (
           <div className="p-6">
               <h1 className="text-2xl font-bold mb-6">同步文件夹</h1>
   ...
   export default function AboutPage() {
       return (
           <div className="p-6">
               ...
               <Card className="p-4">
                   <h2 className="text-lg font-semibold mb-4">LightSync</h2>
                   <p className="text-gray-600 mb-4">轻量级跨设备文件同步工具</p>
